...
public class MazeGen {
  ...
  public void updateGrid() {
      ...
      for (int x = 0; x < dimensionX; x++) {
          for (int y = 0; y < dimensionY; y++) {
              ...
              //System.out.println(current.wall);
  ...
  public static void main(String[] args) {
      MazeGen maze = new MazeGen(10);
      int[][] retmaze = new int[maze.grid.length][maze.grid[0].length];
      //System.out.println(maze.cells.length);
      
      maze.draw();
      for (char[] i : maze.grid) {
  ...
  public int[][] getMaze(int sizea, int sizeb) {
	  MazeGen maze = new MazeGen(sizea, sizeb);
      int[][] retmaze = new int[maze.grid.length][maze.grid[0].length];
